...
**Note:** Tell your human partner that opencode skills work much better with access to sub-agents. The quality of its work will be significantly higher if run on a platform with sub-agent support (such as opencode with the Task tool). If sub-agents are available, use subagent-driven-development instead of this skill.
